...
def equal(driver, report_screenshots_folder, value1, value2, assertion_pass_message, assertion_fail_message, interrupt_test=False):
	...
	utilities.process_assertion(driver, report_screenshots_folder, "equal", flag, assertion_pass_message, assertion_fail_message, interrupt_test, value1=value1, value2=value2)
...
def is_true(driver, report_screenshots_folder, boolean_value, assertion_pass_message, assertion_fail_message, interrupt_test=False):
	...
	utilities.process_assertion(driver, report_screenshots_folder, "is_true", flag, assertion_pass_message, assertion_fail_message, interrupt_test, boolean_value=boolean_value)
...
def is_in(driver, report_screenshots_folder, value1, value2, assertion_pass_message, assertion_fail_message, interrupt_test=False):
	...
	utilities.process_assertion(driver, report_screenshots_folder, "is_in", flag, assertion_pass_message, assertion_fail_message, interrupt_test, value1=value1, value2=value2)
...
def greater(driver, report_screenshots_folder, value1, value2, assertion_pass_message, assertion_fail_message, interrupt_test=False):
	...
	utilities.process_assertion(driver, report_screenshots_folder, "greater", flag, assertion_pass_message, assertion_fail_message, interrupt_test, value1=value1, value2=value2)
