...
def equal(driver, report_screenshots_folder, tmp_test_urls_file_path, value1, value2, assertion_pass_message, assertion_fail_message, interrupt_test=False):
...
def is_true(driver, report_screenshots_folder, tmp_test_urls_file_path, boolean_value, assertion_pass_message, assertion_fail_message, interrupt_test=False):
...
def is_in(driver, report_screenshots_folder, tmp_test_urls_file_path, value1, value2, assertion_pass_message, assertion_fail_message, interrupt_test=False):
...
def greater(driver, report_screenshots_folder, tmp_test_urls_file_path, value1, value2, assertion_pass_message, assertion_fail_message, interrupt_test=False):
